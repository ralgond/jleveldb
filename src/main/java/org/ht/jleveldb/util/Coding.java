...
public class Coding {
	...
	public static void writeFixedNat32(ByteBuf dst, int value) {
		dst.writeFixedNat32(value);
	}
	
	public static void writeFixedNat64(ByteBuf dst, long value) {
		dst.writeFixedNat64(value);
	}
	
	public static void writeVarNat32(ByteBuf dst, int value) {
		dst.writeVarNat32(value);
	}
	
	public static void writeVarNat64(ByteBuf dst, long value) {
		dst.writeVarNat64(value);
	}
	
	public static void writeLengthPrefixedSlice(ByteBuf dst, Slice value) {
		dst.writeLengthPrefixedSlice(value);
	}
	
	// Standard Get... routines parse a value from the beginning of a Slice
	// and advance the slice past the parsed value.
	public static int getVarNat32(Slice input) {
		return getVarNat32Ptr(input);
	}
	
	public static long getVarNat64(Slice input) {
		return getVarNat64Ptr(input);
	}

	// Returns the length of the varint32 or varint64 encoding of "v"
	public static int varNatLength(long v) {
		if (v < 0)
	...
	public static void encodeFixedNat32Long(byte[] buf, int offset, int limit, long value) {
		//Big Endian
	...
	public static void encodeFixedNat64(byte[] buf, int offset, int limit, long value) {
		//Big Endian
		if (value < 0)
	...
	public static void encodeFixedNat64(byte[] buf, int offset, long value) {
		encodeFixedNat64(buf, offset, offset + 8, value);
	}
	
	public static void encodeFixed64(Slice ref, long value) throws Exception {
	...
	// REQUIRES: dst has enough space for the value being written
	public static int  encodeVarNat32(byte[] buf, int offset, int limit, int v) {
	...
	public static void  encodeVarint32(Slice dst, int v) {
		int offset = encodeVarNat32(dst.data, dst.offset, dst.limit, v);
		dst.offset = offset;
	}
	
	public static int encodeVarNat64(byte[] buf, int offset, int limit, long v) {		
		if (v < 0)
	...
	public static void encodeVarint64(Slice dst, long v) {
		int offset = encodeVarNat64(dst.data, dst.offset, dst.limit, v);
		dst.offset = offset;
	}
	
	public static int decodeFixedNat32(byte[] data, int offset, int limit) {
	...
	public static int decodeFixedNat32(byte[] data, int offset) {
		int limit = offset + 4;
		return decodeFixedNat32(data, offset, limit);
	}
	
	public static int decodeFixedNat32(Slice ptr) {
		return decodeFixedNat32(ptr.data, ptr.offset, ptr.limit);
	}
	
	public static long decodeFixedNat64(byte[] data, int offset, int limit) {
		//java byte order is Big Endian
		if (limit - offset < 8)
			throw new BufferUnderflowException();
	...
	public static long decodeFixedNat64(byte[] data, int offset) {
		int limit = offset + 8;
		return decodeFixedNat64(data, offset, limit);
	}
	
	public static long decodeFixedNat64(Slice ptr) {
		return decodeFixedNat64(ptr.data, ptr.offset, ptr.limit);
	}
	
	// Internal routine for use by fallback path of GetVarint32Ptr
	public static int getVarNat32PtrFallback(Slice ref) {
		byte data[] = ref.data;
		int limit = ref.limit;
	...
	public static int getVarNat32Ptr(Slice ref) {
	...
	public static long getVarNat64Ptr(Slice ref) {
		long result = 0;
		byte[] data = ref.data;
		int limit = ref.limit;
	...
	public static boolean getLengthPrefixedSlice(Slice input, Slice result) {
		int len;
		if ((len = getVarNat32(input)) > 0 && input.size() >= len) {
		    result.init(input.data, input.offset, input.size());
