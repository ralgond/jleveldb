...
public abstract class FilterPolicy {
	 ...
	 * Append a filter that summarizes keys[0,n-1] to dst.</br></br>
	 * 
	 ...
	 * the key was in the list of keys passed to createFilter().</br>
	 * This method may return true or false if the key was not on the list, 
	 * but it should aim to return false with a high probability.
	 * 
	 * @param key
	 * @param filter
	 * @return
	 ...
	 * is 10, which yields a filter with ~ 1% false positive rate.</br></br>
	 * 
	 * Callers must delete the result after any database that is using the
	 * result has been closed.</br></br>
	 * 
