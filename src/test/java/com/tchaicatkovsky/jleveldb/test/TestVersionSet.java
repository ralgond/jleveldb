...
public class TestVersionSet {
	static class FindFileTest {
		...
		public void add(String smallest, String largest,
		    ...
		    f.smallest = new InternalKey(SliceFactory.newUnpooled(smallest), smallest_seq, ValueType.Value);
		    f.largest = new InternalKey(SliceFactory.newUnpooled(largest), largest_seq, ValueType.Value);
		    files.add(f);
		}
		
		public int find(String key) {
		    InternalKey target = new InternalKey(SliceFactory.newUnpooled(key), 100, ValueType.Value);
		...
		public boolean overlaps(String smallest, String largest) {
		    InternalKeyComparator cmp = new InternalKeyComparator(BytewiseComparatorImpl.getInstance());
		    Slice s = SliceFactory.newUnpooled(smallest != null ? SliceFactory.newUnpooled(smallest) : SliceFactory.newUnpooled(""));
		    Slice l = SliceFactory.newUnpooled(largest != null ? SliceFactory.newUnpooled(largest) : SliceFactory.newUnpooled(""));
