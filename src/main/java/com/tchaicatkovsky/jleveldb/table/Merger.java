...
//			    String s = "i="+i+", iter.type="+child.iter.getClass().getName(); //TODO: delete before release
//			    s += (", child.valid()="+child.valid());
//			    s += (", child.key="+Strings.escapeString(child.key()));
//			    Logger0.debug("MergingIterator.findSmallest=%s\n", s);
