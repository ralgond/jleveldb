...
public class Coding {
	...
	final public static void appendFixNat64(Slice s, long v) {
	...
	final public static long popVarNat64(Slice ref) {
		long result = 0;
		byte[] data = ref.data();
		int limit = ref.limit();
	...
	final public static void appendVarNat64(Slice s, long v) {
	...
	final public static void appendFixNat32(Slice s, int v) {
	...
	final public static int popVarNat32PtrFallback(Slice ref) {
		byte data[] = ref.data();
		int limit = ref.limit();
		int offset = ref.offset();
	...
	final public static int popVarNat32(Slice ref) {
		byte[] data = ref.data();
		int offset = ref.offset();
		int limit = ref.limit();
	...
	final public static void appendVarNat32(Slice s, int v) {
		int offset = encodeVarNat32(s.data(), s.offset(), s.limit(), v);
		s.setOffset(offset);
	}

	final public static boolean popLengthPrefixedSlice(Slice input, Slice result) {
